...
function setTheme(page, theme) {
    return page.evaluate((t) => {
        localStorage.setItem('enlace.theme', t);
...
async function main() {
    ...
    await page.waitForSelector('h2:has-text("Recent Shares")');
    ...
    await page.waitForSelector('h2:has-text("Your Shares")');
    await setTheme(page, 'light');
    ...
    await page.waitForSelector('h2:has-text("Create New Share")');
    await setTheme(page, 'light');
    ...
    // Wait for the file to appear in the pending files list
    await page.waitForSelector('text=login-light.png');
    ...
    await page.waitForSelector('h3:has-text("Files")');
    ...
    await page.waitForSelector('h3:has-text("Appearance")');
    await setTheme(page, 'light');
    ...
    const adminPages = [
        ...
        { route: 'admin/storage', name: 'admin-storage', selector: 'h3:has-text("Storage Configuration")' },
