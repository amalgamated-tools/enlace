...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.sendNotificationRequest"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/internal_handler.recipientResponse"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "internal_handler.recipientResponse": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string",
        ...
        "internal_handler.sendNotificationRequest": {
            "type": "object",
            "properties": {
                "recipients": {
                    "type": "array",
