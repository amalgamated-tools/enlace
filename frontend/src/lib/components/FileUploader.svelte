...
<div
  class="border-2 border-dashed rounded-xl p-10 text-center transition-all duration-150 {dragover ? 'border-slate-400 bg-slate-50' : 'border-slate-200 hover:border-slate-300'}"
